...
const Card = styled.div`
  ${tw`hover:bg-teal-500 text-secondary-100 hover:text-white flex flex-col mx-auto max-w-xs items-center px-6 py-10 border-2 border-dashed border-primary-500 rounded-lg mt-12`}
  .imageContainer {
  ...
  .description {
    ${tw`mt-3 font-semibold  text-sm leading-loose hover:text-white`}
  }
`;
