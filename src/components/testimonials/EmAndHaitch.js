...
import testimonialbg from "../../images/emandhaitch/why2.jpg";
import testimonialbg1 from "../../images/emandhaitch/testimonial.jpg";
import pic1 from "../../images/emandhaitch/doubra.jpg"
import pic2 from "../../images/emandhaitch/marian.jpg"
...
const CustomerName = tw.h5`font-semibold text-xl lg:text-2xl xl:text-3xl text-emandhaitch`;
const CustomerTitle = tw.p`font-medium text-secondary-100`;

const QuotesLeft = tw(QuotesLeftIcon)`w-6 h-6 opacity-75 text-emandhaitch inline-block mr-1 -mt-3`;
const QuotesRight = tw(QuotesRightIcon)`w-6 h-6 opacity-75 text-emandhaitch inline-block ml-1 -mt-3`;

const DecoratorBlob1 = tw(
  SvgDecoratorBlob1
)`absolute w-32 top-0 left-0 -z-10 text-emandhaitch opacity-25 transform -translate-x-full`;
  ...
  const defaultTestimonials = [
    {
      ...
      customerName: "Doubra Edugo",
      customerTitle: "CEO, DB Xchange Inc."
    },
    {
      imageSrc:
        testimonialbg1,
      ...
      customerName: "Mariam Curtis",
      customerTitle: "Founder, Mariam Place"
    }
  ];
